...
TABLE_INSERT.setInputValue("value", "my custom val")
...
engine.addTransition(Transition(GET_NODE, TABLE_INSERT, TransitionType.DATA, TABLE_INSERT.getInput("table"), GET_NODE.getOutput("value")))
...
engine.addTransition(Transition(GET_NODE, TABLE_INSERT, TransitionType.EXEC))

engine.addNode(START)
engine.addNode(T_MAP)
engine.addNode(SET_NODE)
engine.addNode(GET_NODE)
engine.addNode(TABLE_INSERT)
